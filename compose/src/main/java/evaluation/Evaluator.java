...
//			String singleAlignment = "./files/_PHD_EVALUATION/ATMONTO-AIRM/STROMA/Stroma-ATMONTO-AIRM-EQ.rdf";
...
//			String datasetName = "OAEI2011-"+onto1+onto2+type;
			String alignmentFolder = "./files/_PHD_EVALUATION/ATMONTO-AIRM/ALL_ALIGNMENTS/SUB";
			String refalign = "./files/_PHD_EVALUATION/ATMONTO-AIRM/REFALIGN/ReferenceAlignment-ATMONTO-AIRM-SUB.rdf";
