...
import no.ntnu.idi.compose.Matchers.DataPropertyAlignment;
import no.ntnu.idi.compose.Matchers.GraphAlignment;
import no.ntnu.idi.compose.Matchers.ISubAlignment;
import no.ntnu.idi.compose.Matchers.Property_WordNet;
...
public class MatcherComposition {
	...
	public static void main(String[] args) throws AlignmentException, IOException, URISyntaxException, OntowrapException, OWLOntologyCreationException {
		...
		WordNetAlignment wordNetMatcher = new WordNetAlignment();
		...
		case "Sequential_PartialMatch_ClassEq":
			...
			wordNetAlignment = (BasicAlignment) WordNetAlignment.matchAlignment(structAlignment);
			stringAlignment = (BasicAlignment) WordNetAlignment.matchAlignment(wordNetAlignment);
		...
		case "Parallel_SimpleVote_Subsumption":
			...
			a3 = new File("./files/experiment_eswc17/alignments/" + experiment + "/Subsumption_WordNet.rdf");
