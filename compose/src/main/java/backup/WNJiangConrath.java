...
public class WNJiangConrath extends ObjectAlignment implements AlignmentProcess {

	private static ILexicalDatabase db = new NictWordNet();

	public WNJiangConrath() {
	}
		...
		try {
			...
			for ( Object cl2: ontology2().getClasses() ){
				for ( Object cl1: ontology1().getClasses() ){
					...
					addAlignCell(cl1,cl2, "=", computeWNJiangConrath(cl1,cl2));  
				}
	 ...
	 * @return
	 */
	public double computeWNJiangConrath(Object o1, Object o2) throws AlignmentException, OntowrapException {
