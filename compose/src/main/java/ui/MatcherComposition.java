...
import matchercombination.HybridCombination;
...
public class MatcherComposition {
	...
	public static void main(String[] args) throws AlignmentException, IOException, URISyntaxException, OntowrapException, OWLOntologyCreationException {
		...
		StringEquivalenceMatcher stringMatcher = new StringEquivalenceMatcher();
		WNRiWordNetDistance wordNetMatcher = new WNRiWordNetDistance();
		...
		ParallelCombination par = new ParallelCombination();
		HybridCombination hyb = new HybridCombination();
		...
		case "Sequential_CompleteMatch_ClassEq":
			...
			Alignment seqCompAlignment_classEq = SequentialCombination.weightedSequentialComposition3(a1, a3, a2);
		...
		case "Sequential_NonWeightedCompleteMatch_ClassEq":
			...
			Alignment weightedSeqCompAlignment_classEq = SequentialCombination.nonWeightedCompleteMatch(a1, a3, a2);
		...
		case "Sequential_NonWeightedCompleteMatch_PropEq":
			...
			Alignment weightedSeqCompAlignment_propEq = SequentialCombination.nonWeightedCompleteMatch(a2, a3, a1);
		...
		case "Sequential_CompleteMatch_PropEq":
			...
			//TODO: Create an ArrayList<Alignment> and use the new WeightedSequentialCombination method
			Alignment seqCompAlignment_propEq = SequentialCombination.weightedSequentialComposition3(a3, a2, a1);
		...
		case "Sequential_CompleteMatch_Subsumption":
			...
			//TODO: Create an ArrayList<Alignment> and use the new WeightedSequentialCombination method
			Alignment seqCompAlignment_subsumption = SequentialCombination.weightedSequentialComposition3(a3, a2, a1);
		...
		case "Sequential_PartialMatch_ClassEq":
			...
			wordNetAlignment = (BasicAlignment) WNRiWordNetDistance.matchAlignment(structAlignment);
			stringAlignment = (BasicAlignment) WNRiWordNetDistance.matchAlignment(wordNetAlignment);
		...
		case "Parallel_SimpleVote_ClassEq":
			...
			Alignment Parallel_SimpleVote_ClassEqAlignment = ParallelCombination.simpleVote(aList);
		...
		case "Parallel_SimpleVote_Subsumption":
			...
			Alignment Parallel_SimpleVote_SubsumptionAlignment = ParallelCombination.simpleVote(aList);
		...
		case "Parallel_SimpleVote_PropEq":
			...
			Alignment Parallel_SimpleVote_PropEqAlignment = ParallelCombination.simpleVote(aList);
		...
		case "Parallel_CompleteMatch_WithPriority_ClassEq":
			...
			Alignment Parallel_CompleteMatch_WithPriority_ClassEqAlignment = ParallelCombination.completeMatchWithPriority3(a3, a2, a3);
		...
		case "Parallel_CompleteMatch_WithPriority_PropEq":
			...
			Alignment Parallel_CompleteMatch_WithPriority_PropEqAlignment = ParallelCombination.completeMatchWithPriority3(a3, a1, a2);
		...
		case "Parallel_CompleteMatch_WithPriority_Subsumption":
			...
			Alignment Parallel_CompleteMatch_WithPriority_SubsumptionAlignment = ParallelCombination.completeMatchWithPriority3(a3, a1, a2);
		...
		case "Hybrid_Merge_ClassEq":
			...
			Alignment Hybrid_Merge_ClassEq = HybridCombination.merge(a1, a2, a3);
		...
		case "Hybrid_Merge_PropEq":
			...
			Alignment Hybrid_Merge_PropEq = HybridCombination.merge(a2, a1, a3);
		...
		case "Hybrid_Merge_Subsumption":
			...
			Alignment Hybrid_Merge_Subsumption = HybridCombination.merge(a1, a2, a3);
