...
public class EvaluationMatcherATMOntoAIRM {
	...
	public static void main(String[] args) throws AlignmentException, IOException, URISyntaxException, OWLOntologyCreationException {
		...
		final File ontoFile1 = new File("./files/_PHD_EVALUATION_ATMONTO-AIRM/ONTOLOGIES/ATMOntoCoreMerged.owl");
		final File ontoFile2 = new File("./files/_PHD_EVALUATION_ATMONTO-AIRM/ONTOLOGIES/airm-mono.owl");
