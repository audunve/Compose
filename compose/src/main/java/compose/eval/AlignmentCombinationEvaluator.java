...
/**
 * Evaluates different combinations of alignments (join, meet, ingest from the Alignment API)
 * @author audunvennesland
 * 15. jul. 2017
 */
public class AlignmentCombinationEvaluator {
	...
	public static void main(String[] args) throws AlignmentException, IOException, URISyntaxException {
		...
		//AlignmentParser inputParser = new AlignmentParser(0);
			...
			AlignmentProcess iSubAlignment = new ISubMatcher();
			...
			System.out.println("------------------------------");
			System.out.println("Evaluator scores for the join():");
			System.out.println("------------------------------");
			...
			System.out.println("------------------------------");
			System.out.println("Evaluator scores for the meet():");
			System.out.println("------------------------------");
			...
			System.out.println("------------------------------");
			System.out.println("Evaluator scores for smoa:");
			System.out.println("------------------------------");
			...
			System.out.println("------------------------------");
			System.out.println("Evaluator scores for isub:");
			System.out.println("------------------------------");
			...
			System.out.println("------------------------------");
			System.out.println("Evaluator scores for the ingest():");
			System.out.println("------------------------------");
			System.out.println("F-measure: " + iSubEvaluator.getResults().getProperty("fmeasure").toString());
			System.out.println("Precision: " + iSubEvaluator.getResults().getProperty("precision").toString());
			System.out.println("Recall: " + iSubEvaluator.getResults().getProperty("recall").toString());
