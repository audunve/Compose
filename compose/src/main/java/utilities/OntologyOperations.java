...
public class OntologyOperations {
	...
	public static void main(String[] args) throws OWLOntologyCreationException {
		File ontoFile = new File("./files/ESWC_ATMONTO_AIRM/envo.owl");
	...
	private static Set<String> getEntitySuperclasses (OWLOntology onto, OWLClass inputClass) {
		...
		NodeSet<OWLClass> superclasses = reasoner.getSuperClasses(inputClass, false);
	...
	public static Set<OWLClass> getClassesTwoStepsAway (OWLOntology onto, OWLClass cls) {
		...
		//System.out.println("There are " + ops.size() + " properties associated with " + cls.getIRI().getFragment());
		...
		for (OWLObjectProperty op : ops) {
			...
			//System.out.println(cls.getIRI() + " has " + domains.size() + " domain classes");
		...
		//System.out.println("classesTwoStepsAway contains " + classesTwoStepsAway.size());
		...
		//System.out.println("now classesTwoStepsAway contains " + classesTwoStepsAway.size());
		//		for (OWLClass c : classesTwoStepsAway) {
