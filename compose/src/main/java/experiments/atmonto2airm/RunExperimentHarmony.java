...
public class RunExperimentHarmony {
	...
	final static File ontoFile1 = new File("./files/_PHD_EVALUATION/ATMONTO-AIRM/ONTOLOGIES/ATMOntoCoreMerged.owl");
	final static File ontoFile2 = new File("./files/_PHD_EVALUATION/ATMONTO-AIRM/ONTOLOGIES/airm-mono.owl");
	final static String prefix = "file:";
	final static String storePath = "./files/_PHD_EVALUATION/ATMONTO-AIRM/HARMONY";
