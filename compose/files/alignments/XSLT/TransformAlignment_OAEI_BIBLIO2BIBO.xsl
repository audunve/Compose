...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    exclude-result-prefixes="xs owl rdf ns1"
    version="2.0"
    xmlns:owl="http://www.w3.org/2002/07/owl#"
    xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    xmlns:ns1="http://knowledgeweb.semanticweb.org/heterogeneity/alignment#"
    ...
    <xsl:template match="/">
        ...
        <xsl:apply-templates select="rdf:RDF/ns1:Alignment"></xsl:apply-templates>
        
    </xsl:template>

    
    <xsl:template match="rdf:RDF/ns1:Alignment">
